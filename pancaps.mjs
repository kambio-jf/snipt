...
// usage: node pancaps.mjs clips/2026-07-13/shorts.json delta-safe
import { readFileSync } from "node:fs";
import { execFileSync } from "node:child_process";
import { dirname, resolve, join } from "node:path";
import { anchorTime, srtWordTimeline } from "./cutlib.mjs";

const [, , jsonPath, name] = process.argv;
if (!jsonPath || !name) { console.error("usage: node pancaps.mjs <shorts.json> <name>"); process.exit(1); }
