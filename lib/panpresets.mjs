...
const PRESETS = {
  ...
  "tos-order": {
    x: 640, y: 290,
    note: "thinkorswim order ticket, framed on the leg details: the Sell/Buy toggles, " +
          "quantity, expiration, STRIKE and Call/Put for each leg, plus the order " +
          "summary line above them (\"Sell 10 Iron Condor 320/322.5/325/327.5 @0.16 " +
          "LIMIT Day\"). Those columns span raw x 662-1258, so a 640-wide window at 640 " +
          "holds all of them with ~20px either side - the tightest fit of any preset " +
          "here. y=290 reaches the limit-price row and the confirmation bar at the " +
          "bottom. Derived from a 2026-09-02 screenshot scaled to the 1920 frame rather " +
          "than cropped from a recording, so check it the first time it renders.",
  },
  "yahoo-chart": {
    x: 1280, y: 160,
